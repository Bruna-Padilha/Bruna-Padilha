...
## 📑 Sobre Mim
* 🎓 **Formação:** Graduanda em Engenharia de Software pela **Uniamérica**.
* 💼 **Carreira:** Atualmente **Estagiária de suporte**.
* 🗣️ **Idiomas:** Inglês nível C1 Advanced (EF SET).
* 🛠️ **Foco Atual:** Aprimorando lógica em linguagens de baixo nível e desenvolvimento Web.
